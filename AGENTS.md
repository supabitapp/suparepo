...
bun run supaimg.desktop:dev    # Tauri dev mode
bun run supaimg.desktop:build  # Tauri production build
```
...
- `apps/supaimg-desktop` - Tauri v2 desktop (React 19 + Vite frontend, Rust backend)
- `apps/supaimg.app` - Marketing site
